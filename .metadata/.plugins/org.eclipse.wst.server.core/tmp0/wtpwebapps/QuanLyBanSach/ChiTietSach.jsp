                ...
                <div>
                    ...
                    <div>
                        <div style="width:40%; float:left; border-left: dotted 1px; border-color:azure">
                            <img src=<%="Hinhsanpham/" + sach.getAnhBia()%> width="100%">
                        </div>
                        <div style="width:60%; float:left; padding:10px">
                            <h4 style="font-weight:bold; color:red">Tên sách: <%=sach.getTenSach() %> </h4>
                            <p style="text-align:justify">
                                <span style="font-weight:bold"> Mô tả: </span><%=sach.getMoTa() %>
                            </p>
                            <p style="font-weight:bold"> Giá bán: <span style="color:red; font-size:16pt "><%=sach.getGiaBan() %>&nbsp; VNĐ </span></p>
                        </div>
                        <div>
                            <div id="Datmua">
                                <a href=<%="GioHang/ThemGiohang?iMasach=" + sach.getMaSach()%> class="list-group-item">
                                    ĐẶT MUA
                                </a>
                            </div>
                        </div>
